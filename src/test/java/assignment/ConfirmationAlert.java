...
public class ConfirmationAlert {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// 3. Calls alert.accept() to click OK to execute this uncomment line only	//alert.accept(); 

		// To execute Scenario B uncomment line only //alert.dismiss();
		/*
		 * Scenario B — Dismiss the confirmation alert: 6. Clicks id='confirmBtn' again
		 * 7. Calls alert.dismiss() to click Cancel 8. Reads and prints the text in
		 * id='demo' 9. Asserts it equals 'You pressed Cancel!' — prints PASS or FAIL
		 */
		
		//alert.accept();
		//alert.dismiss();

		// 4. Reads and prints the text in id='demo'
		String resultText = resultElement.getText();
		System.out.println("Result Text: " + resultText);

		// 5. Asserts it equals 'You pressed OK!' — prints PASS or FAIL
		if ("You pressed OK!".equals(resultText)) {
